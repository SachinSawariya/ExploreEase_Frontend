const trainData = [
    ...
    {
      train_number: "09003",
      train_name: "Mumbai Central - Delhi Sarai Rohilla Special",
      run_days: [
        "Fri"
      ],
      train_src: "MMCT",
      ...
      frequency_perc: 0,
      from_distance_text: "",
      to_distance_text: "3 Kms from NDLS",
      duration_rating: 3,
      score_duration: 6,
      score_std: 10,
      score_user_preferred: 0,
